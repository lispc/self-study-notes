...
> 前置知识：本科量子力学（谐振子、电磁场中的带电粒子）、Drude 输运图像（[第 3 章](03-free-electron-gas.md)）、谐振子的代数解法（[量子力学书：谐振子的产生/湮灭算符解法](../../quantum-mechanics/docs/04-harmonic-oscillator-ladder.md)）。
